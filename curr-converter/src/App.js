...
function App() {
    ...
    return (
        <div className="w-full min-h-full h-screen p-6 flex flex-col items-center bg-lime-950 bg-opacity-90" >
            <h1 className=' text-5xl md:text-6xl text-center font-extrabold mt-5 mb-24' style={styles}>CoinQuotient</h1>
